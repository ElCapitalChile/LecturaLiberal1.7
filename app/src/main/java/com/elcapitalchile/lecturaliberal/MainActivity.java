...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_image.add(R.drawable.johnlocke);
        list_image.add(R.drawable.adamsmith);
        list_image.add(R.drawable.thomaspaine);
        list_image.add(R.drawable.benjaminconstantderebecque);
        list_image.add(R.drawable.davidricardo);
        ...
        list_image.add(R.drawable.friedrichhayek);
        list_image.add(R.drawable.karlpopper);
        list_image.add(R.drawable.raymondaron);
        list_image.add(R.drawable.isaiahberlin);
        list_image.add(R.drawable.norbertobobbio);
